...
<div class="row">
	...
	<div class="col-md-<?php echo $columns ?>">
		<div class="form-group">
			<input type="text" name="name" oncopy="return false" onpaste="return false" maxlength="80" class="form-control input-name required" placeholder="<?php echo $first_name_value ?>" value="<?php if($type_incorporate_nc == 0){ echo $last_name_nc; }else{ echo $first_name_nc; } ?>">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
