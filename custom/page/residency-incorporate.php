...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			<input type="text" name="telephone" class="form-control required input-cellular" onkeypress="return JustNumbers(event,$(this).val());" <?php if($country == 3){ ?> maxlength="9" <?php }elseif($country == 8){ ?> maxlength="8" <?php }else{ ?> maxlength="15" <?php } ?> placeholder="<?php echo $cellular_value ?>" value="<?php echo $cellular_nc ?>">
		</div>
	</div>
