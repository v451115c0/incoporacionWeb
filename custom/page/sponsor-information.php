...
<div class="row">
	<div class="col-sm-12">
		<label id="option-sponsor-one"><input type="radio" value="1" name="type-sponsor" onclick="Opacity_type_sponsor();" checked>&nbsp;<strong>Me voy a incorporar con un Asesor de Bienestar Independiente Influencer</strong><br/><small>Conocí NIKKEN a través de un Asesor de Bienestar Independiente Influencer y me voy a incorporar bajo su código.</small></label>
		<div class="row">
			<div class="col-sm-5">
	...
	<hr>
	<div class="col-sm-12">
		<label id="option-sponsor-two"><input type="radio" value="2" name="type-sponsor" id="option-sponsor-1" onclick="Opacity_type_sponsor();">&nbsp;<strong>Un Asesor de Bienestar Independiente Influencer me presentó NIKKEN</strong><br/><small>Conocí NIKKEN a través de un Asesor de Bienestar Independiente Influencer. Sin embargo, <u>no conozco su código</u>.</small></label>
		<br/><br/>
	</div>
	<div class="col-sm-12">
