...
<div class="row">
	<div class="col-sm-12">
		<label id="option-sponsor-one"><input type="radio" value="1" name="type-sponsor" onclick="Opacity_type_sponsor();" checked>&nbsp;<strong>Me voy a incorporar con un Asesor de Bienestar Independiente Influencer</strong><br/><small>Conocí NIKKEN a través de un 
