...
/*NIKKEN CHALLENGE*/
	...
	if(isset($_SESSION["name_nc"])){
		...
		if(isset($name_nc_detail[1])){
			...
			$last_name_detail = explode(" ", $last_name_nc);
			$last_name_nc = $last_name_detail[0];
			$last_second_name_nc = $last_name_detail[1];
		}
	}
...
$first_name_value = "Nombres completos";
$last_name_value = "Apellidos paterno";
$second_last_name_value = "Apellidos maternos";
...
<div class="row">
	...
	if($type != 0)
	{
		...
		<div class="col-md-6">
			<div class="form-group">
				<input type="text" name="second-last-name" onkeypress="return Only_letter(event);" oncopy="return false" onpaste="return false" maxlength="60" class="form-control input-second-last-name required" placeholder="<?php echo $second_last_name_value ?>" value="<?php echo $last_second_name_nc ?>">
			</div>
		</div>
		<?php
	}
	...
	<div class="col-md-<?php echo $columns ?>">
		<div class="form-group">
			<input type="text" name="name" onkeypress="return Only_letter(event);" oncopy="return false" onpaste="return false" maxlength="60" class="form-control input-name required" placeholder="<?php echo $first_name_value ?>" value="<?php echo $first_name_nc ?>">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
