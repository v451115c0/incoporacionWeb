...

{
...

    {
        ...
        document.getElementById("number-clabe-account").disabled = true;

        document.getElementById("number-clabe-account").value = "";
...

    {
        ...
        document.getElementById("number-clabe-account").disabled = false;
